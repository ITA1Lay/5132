...
<header id="header">
	...
	?>
		<div class="product-item">
			...
			<div class="cart-action"><input type="text" class="product-quantity" name="quantity" value="1" style="width:150px" /><br><input type="submit" value="Add to Cart" class="btnAddAction" style="width:150px;height:60px"/></div>
