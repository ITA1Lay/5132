...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($input_salary632)){
        $salary632_err = "Please enter the salary632 amount.";     
    ...
    if(empty($name_err) && empty($address_err) && empty($salary632_err) && empty($username_err)&& empty($password_err)){
        ...
        $sql = "UPDATE employees SET name=?, address=?, salary632=? , username=?, password=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssisss", $param_name, $param_address, $param_salary632, $param_username, $param_password, $param_id);
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label>salary632</label>
                            <input type="text" name="salary632" class="form-control <?php echo (!empty($salary632_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $salary632; ?>">
                            <span class="invalid-feedback"><?php echo $salary632_err;?></span>
                        </div>
                        <div class="form-group">
